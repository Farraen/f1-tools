...
tools_data = [
    {
        ...
        'description': 'A decision engine designed to optimize F1 power unit (PU) selection for the entire season. This engine utilizes a genetic algorithm as the optimizer and incorporates an artificial damage model to assess vehicle performance degradation.x',
...
tools_data = [
    {
        ...
        'image': 'images/Image_1.png',
        'title': 'PU Selection Decision Engine',
        'description': 'A decision engine designed to optimise F1 power unit (PU) selection for the entire season. This engine utilises a genetic algorithm as the optimiser and incorporates an artificial damage model to assess vehicle performance degradation.',
        'category': 'Strategy & Optimization'
    },
    {
        'page': 'PU Optimisation LLM',
